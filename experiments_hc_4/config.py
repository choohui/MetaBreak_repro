...
class ExpConfig:
    ...
    defense_actions: list[str] = field(default_factory=lambda: [
        "drop_token", "drop_token_pm1", "mask_token", "prompt_block"
    ])
...
def add_common_args(p: argparse.ArgumentParser) -> None:
    ...
    p.add_argument("--run_name", default="scalar_threshold")
    ...
    p.add_argument("--defense_actions", default="drop_token,drop_token_pm1,mask_token,prompt_block")
