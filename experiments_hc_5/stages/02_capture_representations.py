...
from experiments_hc_5.core.capture import chat_input_ids, forward_capture_ids, forward_capture_text, row_signals
from experiments_hc_5.core.labels import CAT_TO_LETTER, LETTER_TO_CAT, VARIANT_TO_LETTER
from experiments_hc_5.core.model import get_model, refusal_success
from experiments_hc_5.core.template import (
    content_bounds,
