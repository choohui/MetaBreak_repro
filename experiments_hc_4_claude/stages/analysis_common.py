...
from experiments_hc_4_claude.core import metrics
from experiments_hc_4_claude.core.features import (
    ALL_SIGNALS, COS_SIGNAL, SCALAR_SIGNALS,
    cos_to_ref_matrix, ref_centroids_from, signal_matrix,
)
from experiments_hc_4_claude.core.labels import CAT_A, CAT_TO_LETTER, NEGATIVE_CATS, POSITIVE_CATS
