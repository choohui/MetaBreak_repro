...
D malicious_special, F positioned_regular — per the approved plan) and judges
attack success via refusal-keyword matching (and optional Llama Guard).
...
from experiments_hc_4_claude.core.labels import ASR_VARIANTS  # noqa: E402
...
def _generate(lm, cfg: ExpConfig, text: str) -> dict:
    if getattr(lm, "is_mock", False):
        from experiments_hc_4_claude.core.mock import mock_generate
